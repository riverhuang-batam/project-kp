...
@section('title', 'Create Sale - Purchasing App')
  ...
  <div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
          <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">{{isset($sale) ? 'Edit Existing' : 'Add New'}} Sale</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-muted">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('purchases.index')}}" class="text-muted">Sale</a></li>
                        <li class="breadcrumb-item text-muted active" aria-current="page">{{isset($sale) ? 'Edit' : 'Add'}} Sale</li>
                    </ol>
                </nav>
            </div>
        </div>
         ...
         <form method="POST"
            ...
            <div class="card">
              <div class="card-header">
               <h4 class="page-title text-dark">Sale</h4> 
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ isset($pc) ? $pc : $sale['code'] }}" autocomplete="off" readonly>
                          @error('code')
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control @error('order_date') is-invalid @enderror" id="order_date" name="order_date" value="{{ isset($sale) ? $sale['order_date'] : old('order_date') }}" required>
                          @error('order_date')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          value="{{isset($sale) ? $sale['grand_total'] : (old('grand_total') ? old('grand_total') : 0) }}" readonly>
                          @error('grand_total')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="col-6">
                        ...
                        <div class="form-group">
                          ...
                          value="{{isset($sale) ? $sale['full_name'] : old('full_name') }}">
                          @error('full_name')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="address" name="address" rows="3">{{ isset($sale) ? $sale['address'] : old('address') }}</textarea>
                        </div>

                        <div class="form-group">
                          <label for="remarks">Remarks</label>
                          <textarea class="form-control" id="remarks" name="remarks" rows="3">{{ isset($sale) ? $sale['remarks'] : old('remarks') }}</textarea>
                        </div>
                  ...
                  <div class="col-12">
                    <hr>
                    <div class="d-flex align-items-center">
                      <a href="{{ route('sales.index') }}" type="button" class="btn btn-secondary btn-rounded mr-2">Back</a>
